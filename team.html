...
<main id="index">
    <div class="bt-top article">
        <div class="container">
            <h1 class="h1-join-teacher">با تیم وب آموز اشنا شوید</h1>
        </div>
    </div>
    <div class="container">
        <div class="team">
            <div>
                <div class="team-img">
                    <img src="img/laravel-pic.png" alt="">
                </div>
                <div class="team-content">
                    <span>محمد نیکو</span>
                    <p>توضیحات توضیحات توضیحات توضی حات توضیحات توضی حات</p>
                </div>
            </div>
            <div>
                <div class="team-img">
