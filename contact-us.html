    ...
    <div class="container">
        <div class="t-header-row">
            ...
            <div class="t-header-left">
                ...
                <!--                        <img src="img/profile.png" alt="desction">-->
                <!--                    </div>-->
...
<main id="index">
    <div class="bt-top article">
        <div class="container">
            <h1 class="h1-join-teacher">تماس باما</h1>
        </div>
    </div>
    <article class="container  contact-us">
        <h2 class="h2">پل‌های ارتباطی</h2>
        <p>تلگرام : @nikoo_mohammad</p>
        <p>ایمیل : mohammadniko3@gmail.com</p>
        <p>شماره موبایل (فقط تلگرام یا واتساپ): 09376108107</p>
        <h2>ارسال پیشنهادات و انتقادات</h2>
        <form action="" class="">
            <input type="text" class="txt " placeholder="نام و نام خانوادگی">
            <input type="text" class="txt " placeholder="ایمیل">
            <input type="text" class="txt " placeholder="تلگرام">
            <textarea placeholder="متن پیام"></textarea>
            <button class="btn continue-btn">ارسال</button>
        </form>
    </article>
</main>
<footer>
